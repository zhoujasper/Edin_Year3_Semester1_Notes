...
\begin{enumerate}[itemsep=-2pt, topsep=-2pt]
    ...
    \item \textbf{Find Open Set}: If $f:\underline{\mathbb{R}}\to\mathbb{R}$ $\Rightarrow$ $\{x\in\mathbb{R}:f(x)>\lambda \ (or <\lambda) \ \}$ is open.
...
\begin{enumerate}[itemsep=-2pt, topsep=-2pt]
    ...
    \item \textbf{Find Closed Set}: If $f:\underline{\mathbb{R}}\to\mathbb{R}$ $\Rightarrow$ $\{x\in\mathbb{R}:f(x)\leq\lambda \ (or\geq\lambda) \ (or =\lambda) \ \}$ is closed.
