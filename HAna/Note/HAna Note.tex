...
$\cdot$ \textbf{Special Case}: If $J\subseteq\mathbb{R}$ is interval. $m^*(J)=\lambda(J)$
...
\subsection{Countable Additive for Lebesgue Measure}
...
\textbf{Theorem $\star$|Closed Sets}: If $(K_n)_{n\in\mathbb{N}}$ is disjoint, closed, \textit{bounded} sets \ \ $\Rightarrow$ \ \ $m^*(\cup^\infty_{n}K_n)=\sum^\infty_{n=1} m^*(K_n)$

\textbf{Theorem $\star$|Open Sets}: If $(K_n)_{n\in\mathbb{N}}$ is disjoint, open sets \ \ $\Rightarrow$ \ \ $m^*(\cup^\infty_{n}K_n)=\sum^\infty_{n=1} m^*(K_n)$

\textbf{Theorem $\star$|Powerful}: If $(I_n)_{n\in\mathbb{N}}$ be disjoint intervals. \ \ $\Rightarrow$ \ \ $m^*(\cup^\infty_{n}I_n)=\sum^\infty_{n=1} m^*(I_n)$
