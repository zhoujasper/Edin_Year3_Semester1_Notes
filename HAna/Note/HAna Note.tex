...
\textbf{Important Inequation}: {\small $|x+y|\leq|x|+|y|$ \ \ \ || \ \ \ $|x-y|\geq|x|-|y|$ \ \ \ || \ \ \ $||x|-|y|| \leq|x \pm y|.$}

\hspace{103pt} {\small $|sin(x)|\leq |x|$ {\tiny Hint:By MVT} \ \ \ || \ \ \ $ln(x)<x,x>0$ {\tiny (Hint: MVT)} \ \ \ || \ \ \ $1-cos(x)<|x|$ {\tiny (Hint: MVT)}}
...
\textbf{Power Set $\mathcal{P}$}: $P(E)$ is the set of all subsets of $E$. \ \ \ \ \ \ \ \ \ ps: $\mathcal{P}(\mathbb{R})$ is the set of all subsets of $\mathbb{R}$.

\textbf{Countable Set}: A set $E$ is countable if $\exists$ bijection $f:\mathbb{N}\to E$.

$\cdot$ Properties: {\footnotesize \textbf{1}. Countable union of countable sets is countable. \ \ \ \textbf{2}. Product of finite countable sets is countable. \ \ \ \textbf{3}. Addition of finite countable sets is countable.}

$\cdot$ \textbf{Exmaple}: $[0,1]$ is uncountable.
