...
\begin{longtable}{|l||l|l|l|l|l|}
    ...
    \hline
    {\scriptsize QR Method (ctd.)} & \multicolumn{4}{l|}{ If $\mathbf{R}$ full rank: \ \ $\widehat{\underline{\beta}}=\mathbf{R}^{-1}\mathbf{f}=\mathbf{R}^{-1}\mathbf{Q}^T\mathbf{y}$ \ \ \ $RSS=||\mathbf{r}||^2=||\underline{\varepsilon}(\underline{\widehat{\beta}})||^2=||\mathbf{y}-\mathbf{X}\underline{\widehat{\beta}}||^2$} & $\mathbf{f}=\mathbf{Q}^T\mathbf{y}$ (if $n=p$) \\
    \hline
\end{longtable}
\vspace{-10pt}
}
