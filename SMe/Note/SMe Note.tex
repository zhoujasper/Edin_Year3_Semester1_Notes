...
\begin{enumerate}[itemsep=-2pt, topsep=-2pt]
    ...
    \item Minimises Posterior Expacted Loss Function: $\widehat{\theta}_Q(\mathbf{y})=\arg\min_{\widehat{\theta}}\mathbb{E}[Q(\widehat{\theta},\theta)|\mathbf{y}]=\int_{\theta\in\Theta}Q(\widehat{\theta},\theta)p(\theta|\mathbf{y})d\theta$
\end{enumerate}
