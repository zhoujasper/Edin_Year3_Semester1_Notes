...
\textbf{Normality Assumption}: Assume that $\underline{\varepsilon}\sim\mathcal{N}(0,\sigma^2I_n)$ \ \ $\Rightarrow$ \ \ $^1\mathbf{y}\sim\mathcal{N}(\mathbf{X}\underline{\beta},I_n\sigma^2)$ \ \ \ $^2\underline{\widehat{\beta}}\sim\mathcal{N}(\underline{\beta},\mathbf{V}_{\underline{\widehat{\beta}}})$ \ \ \ || \ \ \textbf{\small 对于 Normal, LS $\underline{\widehat{\beta}}$ = MLE $\underline{\widehat{\beta}}$}
