...
\begin{longtable}[alignment]{|l||l|l|l|l|}
    ...
    \hline
    \hline
    \textbf{Influence / Hat Matrix} $\mathbf{A}$ & $\mathbf{A}=\mathbf{Q}\mathbf{Q}^T=\mathbf{A}^2=\mathbf{X}(\mathbf{X}^T\mathbf{X})^{-1}\mathbf{X}^T$ & \multicolumn{3}{l|}{\# of (identifiable) parameters = $tr(\mathbf{A})=tr(\mathbf{Q}\mathbf{Q}^T)=tr(I_p)=p$} \\
    \hline
