...
\textbf{Linear Model}: $Y_i=\mu_i+\varepsilon_i$ \ , \ $i=1,2,..,n$ \ \ $\mu=f(\beta)$ \ \ || \ \ {\footnotesize $f(\beta)$ linear.} \ \ || \ \ {\footnotesize $\varepsilon_i\stackrel{i.i.d.}{\sim}$ distribution. \ \ \ $\mathbb{E}[\varepsilon_i]=0$ \ \ \ $Var[\varepsilon_i]=\sigma^2$}
