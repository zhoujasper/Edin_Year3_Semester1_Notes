...
\begin{longtable}{|l||l|l|l|l|l|}
    ...
    \hline
    {\scriptsize QR Method (ctd.)} & \multicolumn{4}{l|}{ If $\mathbf{R}$ full rank: \ \ $\widehat{\underline{\beta}}=\mathbf{R}^{-1}\mathbf{f}=\mathbf{R}^{-1}\mathbf{Q}^T\mathbf{y}$ \ \ \ $RSS=||\mathbf{r}||^2=||\underline{\varepsilon}(\underline{\widehat{\beta}})||^2=||\mathbf{y}-\mathbf{X}\underline{\widehat{\beta}}||^2$} & ps:$\mathbf{f}=\mathbf{Q}^T\mathbf{y}$ \ \ \ || \ \ \ $\mathbf{Q}^T\mathbf{Q}=I_p$, $\mathbf{Q}\mathbf{Q}^T\ne I$  \\
    \hline
\end{longtable}
\vspace{-10pt}
}
