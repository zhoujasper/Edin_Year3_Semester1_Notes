...
\textbf{Lemma|$\mathbb{E}$ , $Var$ in Matrix}: {\footnotesize If \ r.v. \ $\mathbf{v}$ \ , \ $\mathbf{A},\mathbf{b}$ constant \ \ $\Rightarrow$ \ \ $^1\mathbb{E}[\mathbf{A}\mathbf{v}+\mathbf{b}]=\mathbf{A}\mathbb{E}[\mathbf{v}] + \mathbf{b}$ \ \ \ $^2Var[\mathbf{Av+b}]=\mathbf{A}Var[\mathbf{v}]\mathbf{A}^T$}
