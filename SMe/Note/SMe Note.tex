...
\textbf{Meaning|CI 表示含义}: \textbf{Not Reject}: If data are generated under $H_0$, there is a probability $(1-\alpha)$ for the true $\theta_0$ to be within the $(1-\alpha)100\%$ CI.
