...
\begin{longtable}[alignment]{|l||l|l|l|l|}
    ...
    \hline
    \multicolumn{5}{|l|}{If $\mathbf{X}^T\mathbf{X}$ is diagonal \ \ $\Rightarrow$ \ \ $\mathbf{X}$ is called Orthogonal. \ \ $\Rightarrow$ In this Case: $\mathbf{V}_{\underline{\widehat{\beta}}}$ diagonal \ \ $\Rightarrow$ \ \ $\beta_i$ independent.} \\
    \hline
\end{longtable}
\vspace{-15pt}
}
